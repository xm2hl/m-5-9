...
func progressUpdate() {
    ...
    be2 -= 1
    if be2 <= 10000 {
        print("You're off to a good start  \(be2)")
    } else if be2 <= 9000 {
        print("You're almost halfway there!  \(be2)")
    } else if be2 <= 5000 {
        print("You're over halfway there!   \(be2)")
    } else if be2 <= 1000  {
        print("You're almost there!   \(be2)")
    }else if be2 == 0 {
        print("You beat your goal!  \(be2)")
    } else {
        print("You beat your goal!  \(be2)")
    }
